      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/expense_categories" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
			...
			<?php 
				$roles = DB::table('expense_categories')->get();
			?>
            ...
            <div class="card">
              ...
              <div class="card-body">
						...
						<div class="modal fade" id="modal-default{{$role->id}}">
							<div class="modal-dialog">
								<div class="modal-content">
									<form method="post" action="/updateexpense_catprocess/{{$role->id}}" class="form-horizontal" enctype="multipart/form-data">
										{{ csrf_field() }}
										...
										<div class="modal-footer justify-content-between">
											<a href="/deleteexpense_catprocess/{{$role->id}}"><button type="button" class="btn btn-danger">Delete</button></a>
				...
				<div class="modal fade" id="modal-default">
					<div class="modal-dialog">
						<div class="modal-content">
							<form method="post" action="/addexpense_catprocess" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								<div class="modal-header">
