            ...
            <div class="card">
              ...
              <div class="card-body">
						...
						<div class="modal fade" id="modal-default{{$user->id}}">
							<div class="modal-dialog">
								<div class="modal-content">
									<form method="post" action="/updateexpensesprocess/{{$user->id}}" class="form-horizontal" enctype="multipart/form-data">
										{{ csrf_field() }}
										...
										<div class="modal-body">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="expense_category" value="{{$user->expense_category}}" required>
											</div>
											<div class="form-group">
												<label for="exampleInputPassword1">Amount</label>
												<input type="number" min="1" class="form-control" name="amount" value="{{$user->amount}}" required>
											</div>
											<div class="form-group">
												<label>Entry Date</label>
												<input type="date" class="form-control" name="entry_date" value="{{$user->entry_date}}" required>
											</div>
										</div>
										
										<div class="modal-footer justify-content-between">
											<a href="/deleteexpensesprocess/{{$user->id}}"><button type="button" class="btn btn-danger">Delete</button></a>
				...
				<div class="modal fade" id="modal-default">
					<div class="modal-dialog">
						<div class="modal-content">
							<form method="post" action="/addexpensesprocess" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								<div class="modal-header">
